...
from coverage_criteria.utils import neuron_boundary, calculate_layers, update_multi_coverage_neuron, \
    calculate_coverage_layer, init_coverage_metric, model_load
...
def multi_testing_criteria(datasets, model_name, model_path, input_shape, samples_path, X_train, X_test, std_range=0.0,
                           k_n=1000, k_l=2,
                           ):

    samples = X_test
    X_train_boundary = X_train
    store_path = '../multi_testing_criteria/' + datasets + '/' + model_name + '/'
