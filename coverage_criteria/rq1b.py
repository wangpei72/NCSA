...
dataset_list = ['adult', 'default', 'meps15', 'meps16'] # 4个
            ...
            for i in range(20):  # Relative dnn5%+ or 100+
                ...
                for k in range(5):  # 每个阶梯大小的TestSet随机选取五遍
                    ...
                    if k == 4:
                        ...
                        csv_writer.writerow(
                            [a, NC, KMN, NB, SNA, TKNC, TKNP, LSA, DSA, nc, kmn, nb, sna, tknc, lsa, dsa])
                    else:
                        csv_writer.writerow([a, NC, KMN, NB, SNA, TKNC, TKNP, LSA, DSA])
